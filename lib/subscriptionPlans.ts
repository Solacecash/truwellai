...
export const PLANS: SubscriptionPlan[] = [
  {
    ...
    ctaSubtext: 'Only 373 Founder memberships remain.',
...

  {
    ...
    ctaColor: 'teal',
    ctaSubtext: 'Coverage for up to 5 family members.',
    rationaleTitle: 'Why Families Love It',
    rationaleBody: 'One place to support your family\'s wellness journey.\nOne subscription. Full wellness coverage for up to 5 loved ones.',
    ...
    features: [
      { text: 'Protect up to 5 family members', included: true, highlight: true },
      { text: 'Family wellness dashboard', included: true, highlight: true },
      { text: 'Children safety mode', included: true, highlight: true },
      { text: 'Allergy alerts', included: true, highlight: true },
      { text: 'Unlimited scans for all profiles', included: true, highlight: false },
      { text: 'Personalized insights for each member', included: true, highlight: false },
      { text: 'Personalized meal plans for each profile', included: true, highlight: false },
      { text: 'Shelf watch alerts', included: true, highlight: false },
      { text: 'Advanced breathing exercises', included: true, highlight: false },
      { text: 'Offline mode', included: true, highlight: false },
      { text: 'Global watchlist alerts', included: true, highlight: false },
    ],
    scanLimit: 'unlimited',
...

  {
    ...
    subheadline: 'Wellness support designed around you.',
    rationaleTitle: 'Why Members Start Here',
    rationaleBody: 'Build better habits with personalized support.',
    displayOrder: 3,
    topBannerLabel: undefined,
    topBannerRight: undefined,
    ...
    features: [
      { text: 'Unlimited personal scans', included: true, highlight: true },
      { text: 'Personalized wellness insights', included: true, highlight: true },
      { text: 'Personalized meal plans tailored to you', included: true, highlight: false },
      { text: 'Shelf watch alerts', included: true, highlight: false },
      { text: 'Advanced breathing exercises', included: true, highlight: false },
      { text: 'Offline access', included: true, highlight: false },
      { text: 'Personal watchlist alerts', included: true, highlight: false },
      { text: 'Recall & ban alerts', included: true, highlight: false },
      { text: 'Allergy alerts', included: true, highlight: false },
